...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lwpa2", "-lexpat", "-lmdns", "-lsmartconfig", "-lod", "-lspi_flash", "-lcxx", "-lbootloader_support", "-lm", "-lpthread", "-lespnow", "-lphy", "-lesp_http_client", "-limage_util", "-ldriver", "-llibsodium", "-lmqtt", "-lwpa", "-llwip", "-lhal", "-lmbedtls", "-lprotobuf-c", "-lbt", "-lesp32-camera", "-lnewlib", "-ltcpip_adapter", "-ljsmn", "-lethernet", "-lbtdm_app", "-lwear_levelling", "-lmicro-ecc", "-lnvs_flash", "-lnghttp", "-llog", "-lsoc", "-lfreertos", "-lopenssl", "-lapp_trace", "-lmesh", "-lfatfs", "-lfb_gfx", "-lxtensa-debug-module", "-ljson", "-lface_recognition", "-lasio", "-lesp_adc_cal", "-lrtc", "-lsdmmc", "-lwps", "-lesp_event", "-lcoexist", "-lapp_update", "-lesp_ringbuf", "-lesp_https_ota", "-lesp32", "-lfr", "-lcoap", "-lconsole", "-lc_nano", "-lulp", "-lhusarnet", "-lspiffs", "-lnet80211", "-lsmartconfig_ack", "-lcore", "-lpp", "-lvfs", "-lprotocomm", "-ldl_lib", "-lheap", "-lface_detection", "-lwifi_provisioning", "-lfd", "-lesp-tls", "-lfreemodbus", "-ltcp_transport", "-lwpa_supplicant", "-lesp_http_server", "-lc", "-lstdc++"
    ],
